...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-9 items-center justify-center gap-6 rounded-lg p-1 text-muted-foreground",
      className
    )}
    {...props}
  />
