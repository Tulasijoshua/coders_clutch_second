        ...
        <section className='max-container 2xl:w-[85%] md:w-[95%] w-[90%] flex md:flex-row flex-col justify-between lg:gap-16 gap-8'>
            <div className='flex-1 '>
                <div className='xl:w-[80%] flex flex-col xl:gap-6 gap-3'>
                    ...
                    >
                        Cities today face: - Increasing congestion and inefficient public services - Lack of real-time infrastructure
                        data - Growing pressure to deliver sustainable development
                    </Typography>
                    <Typography
                        typo="body-medium-regular"
                        className='rale !leading-relaxed'
                    >
                        Our smart infrastructure systems connect public assets, integrate legacy systems, and provide
                        centralized control for efficient urban operations.
                    </Typography>
                    <Button
                        variant="primary"
