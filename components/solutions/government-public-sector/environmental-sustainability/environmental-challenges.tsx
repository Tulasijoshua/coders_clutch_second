            ...
            <div className='flex-1 '>
                <div className='xl:w-[80%] flex flex-col xl:gap-6 gap-3'>
                    ...
                    <ul className='rale list-disc list-inside text-base'>
                        <li>Rising pollution levels and inefficient monitoring systems</li>
                        <li>Difficulty tracking resource consumption and carbon footprint</li>
                        <li>Limited integration between environmental data sources</li>
                    </ul>
                    <Typography
                        typo="body-medium-regular"
                        className='rale !leading-relaxed'
                    >
                        Our sustainability solutions connect environmental sensors, predictive AI, and civic platforms to support
                        smarter and more accountable environmental governance.
                    </Typography>
                    <Button
                        variant="primary"
