        ...
        <div className='max-container lg:w-[85%] w-[95%] mx-auto'>
            <section className='2xl:w-[90%] xl:w-[95%] mx-auto flex flex-col justify-center gap-3 text-white'>
                ...
                <div className='arial md:flex hidden flex-col lg:gap-3 text-white'>
                    ...
                    >
                        Empowering Public Healthcare with
                    </Typography>
                    <Typography
                        className='text-center '
                        typo="header-3-semibold"
                ...
                >
                    Empowering Public Healthcare with Digital Transformation
                </Typography>
                <div className='lg:w-[85%] mx-auto py-3 text-center'>
                    ...
                    >
                        We build next-generation digital health solutions that connect government healthcare systems, clinics,
                        and rural facilities under one secure, integrated platform. With Coders Clutch, public health agencies
                        can enhance access, improve care quality, and enable real-time data for better decision-making.
                    </Typography>
                </div>
