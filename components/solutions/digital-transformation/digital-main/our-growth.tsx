  ...
  return (
    <div className='w-full py-16'>
        <section className='max-container 2xl:w-[85%] md:w-[95%] w-[90%] mx-auto'>
            ...
            <div className='w-full py-6 grid lg:grid-cols-4 sm:grid-cols-2 lg:gap-0 gap-4'>
                {business_growth.map((data) => (
                    <div
                        key={data.id}
                        className='relative 2xl:pl-10 xl:pl-6 pl-4 xl:pr-8 pr-4 lg:pb-0 pb-2 flex flex-col justify-between gap-2 lg:border-l lg:border-b-0 border-b border-dashed border-gray-300'
                    >
                        ...
                        <div className='inter lg:pt-10 sm:pt-5 pt-2 flex flex-col '>
                            <Typography
