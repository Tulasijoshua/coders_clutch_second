        ...
        <div className='max-container lg:w-[85%] w-[95%] mx-auto'>
            <section className='2xl:w-[90%] xl:w-[90%] mx-auto flex flex-col justify-center gap-3 text-white'>
                ...
                <div className='lg:w-[90%] mx-auto flex flex-col py-3 text-center'>
                    ...
                    >
                        Coders Clutch empowers governments and smart city operators with robust data infrastructure and
                        advanced AI solutions. Our platforms enable real-time analytics, predictive modeling, and informed
                        decision-making to optimize resource allocation, urban planning, and policy execution.
                    </Typography>
                </div>
                <div className='lg:w-[80%] mx-auto flex flex-col items-center gap-10'>
                    <div className=' grid xs:grid-cols-2 gap-4'>
                        {
                            data_ai_services.map(data => (
