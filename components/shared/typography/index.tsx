...
const typoVariants = cva("overflow-wrap overflow-hidden leading-normal", {
  variants: {
    typo: {
      ...
      "header-2-light": "xl:text-[49px] sm:text-[40px] sm:text-[35px] xs:text-[30px] text-[25px] xs:leading-[64px] leading-[45px] font-light",
      "header-2-regular": "xl:text-[49px] sm:text-[40px] sm:text-[35px] xs:text-[30px] text-[25px] xs:leading-[64px] leading-[45px] font-normal",
      "header-2-medium": "xl:text-[49px] sm:text-[40px] sm:text-[35px] xs:text-[30px] text-[25px] xs:leading-[64px] leading-[45px] font-medium",
      "header-2-semibold": "xl:text-[49px] sm:text-[40px] sm:text-[35px] xs:text-[30px] text-[25px] sm:leading-[64px] leading-[45px] font-semibold",
      ...
      "header-4-regular": "lg:text-[31px] sm:text-[28px] xs:text-[25px] text-[18px] leading-[47px] font-normal",
      "header-4-medium": "lg:text-[31px] sm:text-[28px] xs:text-[25px] text-[18px] leading-[47px] font-medium",
      "header-4-semibold": "lg:text-[31px] sm:text-[28px] xs:text-[25px] text-[18px] lg:leading-[47px] leading-[37px] font-semibold",
