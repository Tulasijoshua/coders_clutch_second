...
const typoVariants = cva("overflow-wrap overflow-hidden leading-normal", {
  variants: {
    typo: {
      ...
      "body-large-regular": "xl:text-[18px] md:text-[15px] sm:text-[14px] text-[15px] leading-normal font-normal",
      "body-large-medium": "xl:text-[18px] md:text-[15px] sm:text-[14px] text-[15px] leading-normal font-medium",
      "body-large-semibold": "xl:text-[18px] md:text-[15px] sm:text-[14px] text-[15px] leading-normal font-semibold",
