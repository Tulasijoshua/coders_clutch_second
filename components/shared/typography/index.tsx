...
const typoVariants = cva("overflow-wrap overflow-hidden leading-normal", {
  variants: {
    typo: {
      ...
      "header-2-regular": "xl:text-[49px] sm:text-[40px] sm:text-[35px] xs:text-[30px] text-[25px] xl:leading-[64px] sm:leading-[50px] leading-[45px] font-normal",
      "header-2-medium": "xl:text-[49px] sm:text-[40px] sm:text-[35px] xs:text-[30px] text-[25px] xl:leading-[64px] sm:leading-[50px] leading-[45px] font-medium",
      "header-2-semibold": "xl:text-[49px] sm:text-[40px] sm:text-[35px] xs:text-[30px] text-[25px] xl:leading-[64px] sm:leading-[50px] leading-[45px] font-semibold",
